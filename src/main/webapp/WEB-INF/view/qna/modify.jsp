...
<body>
	...
	<form id="registForm">
		...
		<input type="hidden" id="token" name="qnaId" value="${qnaVO.qnaId}" />
		<div class="bo_w_tit write_div">
			<label for="wr_subject" class="sound_only">제목<strong>필수</strong></label>
			
			<div id="autosave_wrapper write_div">
				<input type="text" value="${qnaVO.title}" name="title"  id="wr_title" required="required" class="frm_input full_input required" size="50" maxlength="255" placeholder="제목을 입력하세요."/>            
			</div>
		</div>
		...
		<div class="write_div">
			...
			<div class="wr_content ">
				...
				<textarea id="wr_content" name="content" class="" maxlength="65536" rows="5" cols="30" required="required" placeholder="내용을 입력하세요.">${qnaVO.content}</textarea>
				<span class="sound_only">웹 에디터 끝</span>                    
			</div>
		</div> 

		<div class="btn_confirm write_div">
			<a href="<c:url value="/qna/detail/${qnaVO.qnaId}"/>" class="btn_cancel btn"><i class="icon ion-md-close" aria-hidden="true"></i>취소</a>
